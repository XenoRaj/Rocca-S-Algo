...
pair<string, string> Rocca_S_sw(string K_string, string N_string, string AD_string, string M_string)
{
    ...
    pair<string,string> ans(cipher_output,tag_output);
    return ans;
}
...
int main()
{
    ...
    for (int i = 1; i <= 7; i++)
    {
        ...
        pair<string, string> sw_output;

        sw_output = Rocca_S_sw(K_string, N_string, AD_string, M_string);

        string sw_cipher_output = sw_output.first;
        string sw_tag_output = sw_output.second;
...
//        	printf("nonce\n");
        ...
        {
//        	printf("AD\n");
            string ad = AD_string.substr(i, 2);
